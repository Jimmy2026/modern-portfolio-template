...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      points: [
        'Designed 15-table PostgreSQL schema with automated triggers for real-time donor statistics and campaign performance tracking',
        'Built row-level security (RLS) policies for multi-tenant data isolation across 3-10 nonprofit sites',
        'Integrated Hugging Face API with custom prompts to generate executive reports analyzing 300+ donations and identifying at-risk donors',
        'Created responsive dashboard with Next.js 14 Server Components displaying KPIs, donor retention cohorts, and site-comparison analytics',
        'Configured serverless architecture with Supabase backend and Vercel deployment pipeline for zero-cost scalability',
      ],
